...
var lookupUUID_1 = require("./lookupUUID");
/**
 *  @param {string} player
 */
function lookupName(player) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchDom_1.fetchDOM("search?q=" + player)];
                case 1:
                    $ = _a.sent();
                    results = $("body > main > div.row > div.col-lg-7").children(".card.mb-3");
                    final = [];
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                ...
                                                _b = (_a = final).push;
                                                return [4 /*yield*/, lookupUUID_1.lookupUUID(uuid)];
                                            case 1:
                                                // Push full lookup to results
                                                _b.apply(_a, [_c.sent()]);
